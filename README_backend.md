# 🎙️ NovaVoice AI — Production-Grade Dual-AI Perpendicular Voice Platform

> Ultra-low latency, real-time conversational AI voice platform powered by Dual-AI Perpendicular Workbench, FastAPI, WebSockets, and modular voice infrastructure.
...
```bash
git clone https://github.com/ianuj-yadav/Google-Bootcamp-Voice-Assistant.git
```
...
NovaVoice is an ultra-low latency, bidirectional streaming voice assistant that integrates the **Dual-AI Perpendicular Workbench** with **Google Calendar** for automated schedule checking and meeting booking.
...
🗣️ User (Voice/Mic) 
       │
       ▼ (16kHz PCM Mono)
🖥️ Web Browser UI (index.html on Port 8000) ───[WebSocket WSS]───► 🤖 Dual-AI Perpendicular Workbench
       │                                                                │
...
2. Paste your API Key into the prompt and click connect.
...
4. View the scrolling console logs and interactive tool cards in real-time as our Dual-AI checks slots, determines availability, and pushes the booking to your Google Calendar!
